...
public class MMovement extends X_M_Movement implements DocAction
{
	...
	protected void checkMaterialPolicy(MMovementLine line,BigDecimal qtyToDeliver)
	{
		...
		if (line.getM_AttributeSetInstance_ID() == 0)
		{
			...
			MStorageOnHand[] storages = MStorageOnHand.getWarehouseOfDate(getCtx(), 0, line.getM_Product_ID(), 0, 
					null, MClient.MMPOLICY_FiFo.equals(MMPolicy), true, line.getM_Locator_ID(), get_TrxName(), getMovementDate());
