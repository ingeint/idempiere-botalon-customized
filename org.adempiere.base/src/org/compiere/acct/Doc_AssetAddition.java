...
public class Doc_AssetAddition extends Doc
{
	...
	public BigDecimal getCurrencyRate() {
		MAssetAddition add = (MAssetAddition) this.getAssetAddition();
		if (add.get_ValueAsBoolean("IsOverrideCurrencyRate"))
			return add.getCurrencyRate();
		return super.getCurrencyRate();
	}
}
